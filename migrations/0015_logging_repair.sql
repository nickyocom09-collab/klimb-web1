-- Repair atomic Klimb logging without enabling any subscription features.
--
-- This is intentionally separate from the future entitlement migration so
-- logging can ship now while subscriptions remain uncommitted.
