...
function ToggleSwitch({ enabled }: { enabled: boolean }) {
  return (
    <span
      aria-hidden="true"
      className={`relative isolate h-7 w-12 shrink-0 overflow-hidden rounded-full border transition-[background-color,border-color,box-shadow] duration-300 ease-[cubic-bezier(0.32,0.72,0.24,1)] ${
        enabled
    ...
    >
      <span
        className={`absolute left-0 top-[3px] h-5 w-5 rounded-full transition-[transform,background-color,box-shadow] duration-300 ease-[cubic-bezier(0.32,0.72,0.24,1)] will-change-transform ${
          enabled
